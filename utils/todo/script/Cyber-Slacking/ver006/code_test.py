...
#sb.tv_split("images", "labels",rate=.8, ann_suffix=".xml", cp_mv="cp")
#sb.tvt_split("images", "labels",ann_suffix=".xml", cp_mv="mv")


#------------------------
# gt_bbox_check()模块
#------------------------
#sb.gt_bbox_check(images_dir="/home/user/wuzhe/darknet/darknet/train_coco/train_images", 
...
# crawl_images()模块
#------------------------
#sb.crawl_images(word='smoke fire', total_page=2, start_page=1, per_page=60, t_interval=.005)
